<div>
    ...
    @section('script')
        <script>
            ...
            // Sweet Alert for fulltext validation success (dengan delay untuk tunggu modal tertutup)
            window.addEventListener('fulltext-validation-success', event => {
            ...
            // Sweet Alert for fulltext validation error
            window.addEventListener('fulltext-validation-error', event => {
                Swal.fire({
                    title: event.detail.title,
                    text: event.detail.message,
                    icon: event.detail.icon,
