                                        ...
                                        <div class="col-lg-12">
                                            <div class="schedule-tab">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li class="nav-item col-5 mx-auto text-center">
                                                        ...
                                                        <div class="st-content">
                                                            <div class="container">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <ul class="sc-widget">
                                                                            <li><i class="fa fa-clock-o"></i> 07.00-08.00
                                                                                WIB</li>
                                                                            <li><i class="fa fa-map-marker"></i>
                                                                                Senate meeting building UNJA, Jambi <br>
                                                                                <li><i class="fa fa-map-marker"></i>
                                                                                FST B building 3rd floor
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="st-content">
                                                            <div class="container">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <ul class="sc-widget">
                                                                            <li><i class="fa fa-clock-o"></i> 08.00-08.30
                                                                                WIB</li>
                                                                            <li><i class="fa fa-map-marker"></i>
                                                                                Senate meeting building UNJA, Jambi <br>
                                                                                <li><i class="fa fa-map-marker"></i>
                                                        ...
                                                        <div class="st-content">
                                                            <div class="container">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <ul class="sc-widget">
                                                                            <li><i class="fa fa-clock-o"></i> 08.30-12.00
                                                                                WIB</li>
                                                                            <li><i class="fa fa-map-marker"></i>
                                                                                Senate meeting building UNJA, Jambi <br>
                                                                                <li><i class="fa fa-map-marker"></i>
                                                        ...
                                                        <div class="st-content">
                                                            <div class="container">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <ul class="sc-widget">
                                                                            <li><i class="fa fa-clock-o"></i> 12.00-13.00
                                                                                WIB</li>
                                                                            <li><i class="fa fa-map-marker"></i>
                                                                                Senate meeting building UNJA, Jambi <br>
                                                                                <li><i class="fa fa-map-marker"></i>
                                                        ...
                                                        <div class="st-content">
                                                            <div class="container">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <ul class="sc-widget">
                                                                            <li><i class="fa fa-clock-o"></i> 13.00-16.30
                                                                                WIB</li>
                                                                            <li><i class="fa fa-map-marker"></i>
                                                                                Senate meeting building UNJA, Jambi <br>
                                                                                <li><i class="fa fa-map-marker"></i>
                                                        ...
                                                        <div class="st-content">
                                                            <div class="container">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <ul class="sc-widget">
                                                                            <li><i class="fa fa-clock-o"></i> 16.30-17.00
                                                                                WIB</li>
                                                                            <li><i class="fa fa-map-marker"></i>
                                                                                Senate meeting building UNJA, Jambi <br>
                                                                                <li><i class="fa fa-map-marker"></i>
