<div>
    <form wire:submit.prevent="store" class="flex flex-col gap-5">
        ...
        <button type="submit" class="bg-gradient-to-r from-orange-400 to-pink-400 border-none text-white font-semibold p-2 outline-none outline-offset-0 focus:border-sky-500 focus:outline-4 focus:outline-sky-300 rounded-md transition-all">Login</button>
    </form>
</div>
